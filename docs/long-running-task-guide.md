...
```bash
# 推荐：tee 同时输出到屏幕和文件
your-command 2>&1 | tee /home/node/.openclaw/workspace/logs/<task-name>.log

# 或重定向
your-command > /home/node/.openclaw/workspace/logs/<task-name>.log 2>&1
```
...
监控状态存储在：
```
/home/node/.openclaw/workspace/.task-monitor.json
```
