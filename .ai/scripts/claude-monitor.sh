...
# ========== 配置 ==========
SESSION="claude-code"
LOG_FILE="/home/node/.openclaw/workspace/scripts/claude-monitor.log"
REPORT_FILE="/home/node/.openclaw/workspace/scripts/claude-report.txt"
LOCK_FILE="/home/node/.openclaw/workspace/scripts/claude-monitor.lock"
