...
```bash
# 运行测试
python /home/node/.openclaw/workspace/scripts/browser-use-test.py

# 交互模式
python /home/node/.openclaw/workspace/scripts/browser-use-test.py --interactive
```
...
```
exec command:"python /home/node/.openclaw/workspace/scripts/browser-use-test.py"
```
...
执行：
```bash
python /home/node/.openclaw/workspace/scripts/browser-use-test.py --task "XXX"
```
```
