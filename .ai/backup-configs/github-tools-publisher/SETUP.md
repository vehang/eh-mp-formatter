...
```
/home/node/.openclaw/skills/github-tools-publisher/
├── SKILL.md              # Skill 主文件
├── accounts.json         # 公众号配置
...
```bash
# 今日热门（默认）
bash /home/node/.openclaw/skills/github-tools-publisher/scripts.sh daily "" 10

# 本周热门，JavaScript 项目
bash /home/node/.openclaw/skills/github-tools-publisher/scripts.sh weekly javascript 5

# 本月热门，Python 项目
bash /home/node/.openclaw/skills/github-tools-publisher/scripts.sh monthly python 8
```
